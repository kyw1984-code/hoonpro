            ...
            <section className="grid grid-cols-[1fr_360px] gap-5">
              <div className="space-y-5">
                ...
                <div className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
                  ...
                  <table className="mt-4 w-full text-sm"><thead className="bg-slate-50 text-xs font-black text-slate-500"><tr><th className="px-3 py-3 text-left">순위</th><th className="px-3 py-3 text-left">상품</th><th className="px-3 py-3 text-right">가격</th><th className="px-3 py-3 text-right">리뷰</th><th className="px-3 py-3 text-right">판매량 추정</th><th className="px-3 py-3 text-center">배송</th></tr></thead><tbody>{selectedProduct.competitors.map((competitor) => <tr key={competitor.name} className="border-b border-slate-100"><td className="px-3 py-3 font-bold">{competitor.rank}</td><td className="px-3 py-3 font-bold">{competitor.name}</td><td className="px-3 py-3 text-right">{won(competitor.price)}</td><td className="px-3 py-3 text-right">{fmt(competitor.reviews)}</td><td className="px-3 py-3 text-right">{fmt(competitor.estimatedSales)}</td><td className="px-3 py-3 text-center">{competitor.delivery}</td></tr>)}</tbody></table>
                </div>
