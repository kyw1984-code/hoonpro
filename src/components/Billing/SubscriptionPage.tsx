      ...
      {!hasActiveSub ? (
        ...
        <div className="rounded-panel border border-line bg-paper p-7">
          ...
          <p className="mt-3 text-center text-[11.5px] leading-relaxed text-ink-3">
            ...
            결제 후 7일 이내 한 번도 사용하지 않으셨다면 전액 환불됩니다.<br />
            월간은 이용을 시작한 뒤에는 환불되지 않고, 해지하면 결제한 기간까지 그대로 이용합니다.<br />
        ...
        <div className="space-y-5">
          <div className="rounded-panel border border-line bg-paper p-7">
              ...
              <button
                onClick={() => {
                  const detail = plan?.interval === 'year'
                    ...
                    : '· 이미 이용을 시작하셨다면 환불되지 않습니다. [해지]로 기간까지 이용해주세요';
                  if (window.confirm(
                    `환불과 함께 즉시 이용이 종료됩니다.\n\n`
                    + `· 결제 후 7일 이내 미사용이면 전액 환불\n`
                    + `${detail}\n`
                    + `· 환불은 계정당 한 번뿐입니다\n\n`
            ...
            <p className="mt-2 text-[11.5px] leading-relaxed text-ink-3">
              <b className="text-ink-2">해지</b>는 결제한 기간까지 그대로 쓰고 다음 결제만 멈춥니다. 되돌릴 수 있고, 대부분 이쪽이 유리합니다.
              <b className="text-ink-2"> 환불 요청</b>은 결제 후 7일 이내에 한 번도 사용하지 않으셨을 때 전액 돌려드립니다
              {plan?.interval === 'year' && ' (연간은 그 외에도 사용 기간을 월 요금으로 재정산해 환불)'}. 계정당 1회.
            </p>
            ...
            {status!.payments.length === 0 ? (
              ...
              <div className="overflow-x-auto">
                ...
                <p className="mt-3 text-[11.5px] leading-relaxed text-ink-3">
                  신용카드 매출전표가 부가가치세법상 적격증빙입니다. 위 공급가액·부가세로 매입세액 공제를 받으시면 됩니다.
                  카드결제만 지원하므로 세금계산서는 발급하지 않습니다 — 같은 거래에 둘 다 발급하면 이중공제가 됩니다.
                </p>
              </div>
            )}
          </div>
