        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
            <div className="mb-7 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                <div>
                    ...
                    <h2 className="mt-3 text-3xl font-semibold tracking-tight text-ink">썸네일 제작</h2>
                ...
                <div className="rounded-card border border-line bg-paper">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            className="w-full p-3 border border-line-strong rounded-card focus:ring-2 focus:ring-accent outline-none" 
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-5">
                            <button
                                ...
                                className={`flex items-center justify-center gap-2 p-3 rounded-card border font-bold transition-all ${shotType === 'product' ? 'border-ink bg-ink text-white ' : 'border-line text-ink-2 hover:border-line-strong hover:bg-paper-2'}`}
                            >
                            ...
                            <button
                                ...
                                className={`flex items-center justify-center gap-2 p-3 rounded-card border font-bold transition-all ${shotType === 'model' ? 'border-ink bg-ink text-white ' : 'border-line text-ink-2 hover:border-line-strong hover:bg-paper-2'}`}
                            >
                    ...
                    {shotType === 'model' && (
                        <div className="space-y-4 mb-5 p-4 bg-paper-2 rounded-card border border-line">
                            <div>
                                <label className="block text-xs font-bold text-ink-2 uppercase mb-2">모델 인종</label>
                                <div className="grid grid-cols-2 gap-2">
                                    <button
                                        onClick={() => setModelEthnicity('asian')}
                                        className={`p-2 rounded-control border text-sm font-bold transition-all ${modelEthnicity === 'asian' ? 'bg-paper border-ink text-ink ' : 'bg-transparent border-line text-ink-2 hover:bg-paper'}`}
                                    >
                                        동양인
                                    </button>
                                    <button
                                        onClick={() => setModelEthnicity('western')}
                                        className={`p-2 rounded-control border text-sm font-bold transition-all ${modelEthnicity === 'western' ? 'bg-paper border-ink text-ink ' : 'bg-transparent border-line text-ink-2 hover:bg-paper'}`}
                                    >
                                        서양인
                                    </button>
                                </div>
                            ...
                            <div>
                                <label className="block text-xs font-bold text-ink-2 uppercase mb-2">모델 성별</label>
                                <div className="grid grid-cols-2 gap-2">
                                    <button
                                        onClick={() => setModelGender('female')}
                                        className={`p-2 rounded-control border text-sm font-bold transition-all ${modelGender === 'female' ? 'bg-paper border-ink text-ink ' : 'bg-transparent border-line text-ink-2 hover:bg-paper'}`}
                                    >
                                        여성
                                    </button>
                                    <button
                                        onClick={() => setModelGender('male')}
                                        className={`p-2 rounded-control border text-sm font-bold transition-all ${modelGender === 'male' ? 'bg-paper border-ink text-ink ' : 'bg-transparent border-line text-ink-2 hover:bg-paper'}`}
                                    >
                                        남성
                                    </button>
                                </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-5">
                            <button
                                ...
                                className={`flex items-center justify-center gap-2 p-3 rounded-card border font-bold transition-all ${backgroundType === 'white' ? 'border-ink bg-ink text-white ' : 'border-line text-ink-2 hover:border-line-strong hover:bg-paper-2'}`}
                            >
                            ...
                            <button
                                ...
                                className={`flex items-center justify-center gap-2 p-3 rounded-card border font-bold transition-all ${backgroundType === 'natural' ? 'border-ink bg-ink text-white ' : 'border-line text-ink-2 hover:border-line-strong hover:bg-paper-2'}`}
                            >
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            className="w-full p-3 border border-line-strong rounded-card focus:ring-2 focus:ring-accent outline-none mb-3" 
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            {(['top', 'middle', 'bottom'] as const).map((pos) => (
                                <button
                                    ...
                                    className={`py-2 px-3 rounded-control border text-sm font-bold transition-all ${textPosition === pos ? 'border-ink bg-ink text-white' : 'border-line text-ink-2 hover:border-line-strong hover:bg-paper-2'}`}
                                >
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            rows={2}
                            className="w-full p-3 border border-line-strong rounded-card focus:ring-2 focus:ring-accent outline-none resize-none" 
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-3">
                            <div 
                                ...
                                className="border-2 border-dashed border-line-strong rounded-card bg-paper-2/70 p-6 text-center cursor-pointer transition-colors hover:border-ink hover:bg-paper"
                            >
                    ...
                    <button 
                        ...
                        disabled={loading}
                        className="w-full bg-ink hover:bg-ink-2 disabled:bg-line-strong text-white font-semibold py-3.5 px-8 rounded-card flex items-center justify-center transition-colors mt-4"
                    >
                ...
                <div className="mb-5 flex items-center justify-between">
                    ...
                    {resultImage && (
                        <a 
                            ...
                            className="bg-ink hover:bg-ink-2 text-white font-bold py-2.5 px-4 rounded-card flex items-center transition-colors"
                        >
