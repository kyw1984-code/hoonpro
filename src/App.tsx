...
import { Home, FolderOpen, BarChart3, LogOut, ShieldCheck, Zap, TrendingUp, ListOrdered, MessageSquareText, MessageCircleQuestion, CreditCard, Lock, ShoppingBag, Loader2 } from 'lucide-react';
...
type TabDef = { id: Tab; label: string; icon: typeof Home };

const TABS: TabDef[] = [
  { id: 'home', label: '홈', icon: Home },
  { id: 'sourcing', label: '소싱AI', icon: TrendingUp },
  { id: 'ranktracker', label: '순위추적AI', icon: ListOrdered },
  { id: 'review', label: '리뷰 분석AI', icon: MessageSquareText },
  { id: 'analyzer', label: '광고분석AI', icon: BarChart3 },
  { id: 'coupang', label: '정산AI', icon: ShoppingBag },
