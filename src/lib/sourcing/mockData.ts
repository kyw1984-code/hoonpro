...
const seeds = [
  ['냉감 스포츠 마스크', '스포츠', 16900, 2500, 82, 82400, 67, 1430, 18, 70, 30, '아마추어'],
  ['차량 햇빛가리개', '자동차', 15900, 3300, 96, 76200, 58, 1210, 24, 38, 22, '아마추어'],
  ['휴대용 신발건조기', '생활', 34900, 9800, 144, 54200, 49, 730, 31, 44, 26, '준프로'],
  ['냉감 침대패드', '생활', 42900, 14500, 238, 69800, 41, 850, 42, 62, 35, '준프로'],
  ['스포츠 팔토시 2종', '스포츠', 12900, 2100, 61, 48800, 72, 980, 17, 48, 18, '아마추어'],
  ['실리콘 음식덮개', '주방', 11900, 1800, 44, 36200, 35, 640, 22, 24, 20, '아마추어'],
  ['캠핑 접이식 선반', '스포츠', 29900, 9200, 312, 31500, 28, 410, 46, 36, 31, '준프로'],
  ['반려동물 쿨매트', '반려동물', 21900, 5900, 104, 40700, 63, 690, 27, 52, 26, '아마추어'],
  ['유아 모서리 보호대', '육아', 13900, 2600, 68, 29600, 32, 530, 26, 29, 19, '아마추어'],
  ['무타공 욕실 선반', '생활', 18900, 4300, 352, 45200, 24, 600, 55, 58, 42, '준프로'],
  ['저소음 탁상 선풍기', '생활', 24900, 7300, 211, 88200, 46, 1220, 48, 68, 44, '준프로'],
  ['아이스 넥쿨러', '스포츠', 17900, 4100, 58, 61100, 75, 1040, 20, 56, 24, '아마추어'],
  ['차량용 틈새 수납함', '자동차', 14900, 3600, 173, 34200, 19, 430, 39, 31, 28, '아마추어'],
  ['프리미엄 빨래 건조볼', '생활', 10900, 1900, 92, 22700, 27, 360, 33, 12, 16, '아마추어'],
  ['초경량 등산 무릎보호대', '스포츠', 19900, 5100, 131, 37800, 44, 560, 29, 35, 21, '아마추어'],
  ['주방 싱크대 배수망', '주방', 8900, 950, 38, 31800, 31, 720, 19, 18, 16, '아마추어'],
  ['강아지 산책 물병', '반려동물', 15900, 3400, 88, 28600, 39, 480, 24, 26, 18, '아마추어'],
  ['멀티 케이블 정리함', 'DIY', 12900, 2300, 75, 25100, 22, 370, 28, 16, 20, '아마추어'],
  ['문구 데스크 정리 트레이', '문구', 13900, 2900, 53, 18400, 18, 260, 21, 11, 14, '아마추어'],
  ['접이식 장바구니 캐리어', '생활', 32900, 11800, 422, 39800, 29, 390, 61, 55, 37, '프로'],
  ['여름 자외선 차단 모자', '패션', 18900, 4200, 126, 51600, 54, 820, 32, 46, 29, '아마추어'],
  ['아기 이유식 큐브 트레이', '육아', 14900, 3100, 73, 26400, 37, 410, 25, 22, 18, '아마추어'],
  ['차량용 무선 청소기 필터', '자동차', 9900, 1600, 45, 21900, 26, 300, 23, 13, 15, '아마추어'],
  ['캠핑 식기 건조망', '스포츠', 15900, 3700, 117, 29300, 43, 440, 35, 31, 24, '아마추어'],
  ['방수 네임스티커 세트', '문구', 7900, 900, 39, 17800, 21, 310, 18, 9, 12, '아마추어'],
  ['고양이 창문 해먹', '반려동물', 24900, 7900, 286, 33600, 34, 360, 49, 42, 30, '준프로'],
  ['실리콘 에어프라이어 용기', '주방', 13900, 2400, 64, 44700, 52, 770, 23, 33, 24, '아마추어'],
  ['욕실 곰팡이 제거젤', '생활', 9900, 1500, 185, 38100, 16, 610, 43, 37, 32, '준프로'],
  ['DIY 가구 이동 패드', 'DIY', 11900, 2100, 58, 20600, 25, 290, 27, 14, 17, '아마추어'],
  ['스마트폰 방수팩', '스포츠', 10900, 1700, 91, 58800, 61, 980, 26, 49, 27, '아마추어'],
] as const;
